...
a = 1000
def just_pass_data(a):
    print(a+100)
    return a

def test_check_data():
    assert just_pass_data(a) == 100, "Not the same"

# @pytest.mark.run(order=2)
def test_9():
    print('test01')
    assert 100 == 100, "100!=100"
    assert 100 == 90, "Incorrect"
    assert 200 == 200, "True 200=200" # this line is not executed since last assertion failed
#
# @pytest.mark.run(order=1)
# def test_8():
#     print('test01')
