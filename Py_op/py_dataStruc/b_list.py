...
#------------------------------------------------------
# arr is reference 13325416 to a resource
arr = [] # 13325416
def helper(arr): # here arr  reference 13325416
    print(id(arr)) # 13325416
    b = [1,2,3]
    arr = b # arr  reference 13325416 point to a different resource
...
#   list.extend(list2)
#   list2 must be a list or iterable; adds the elements in list2 to the end of the list.
...
#   list.index(elem)
#   searches the given element and returns its index.
