...
for button in radio_button:
    if button.get_attribute('value') =='radio2':
        ...
        driver.save_screenshot('radio2.png')
...
radio_button_3 = driver.find_element_by_xpath(radio_button_3)

print(f"radio3 is enabled/selected: {radio_button_3.is_selected()}")
radio_button_3.click()
print(f"radio3 is enabled/selected: {radio_button_3.is_selected()}")
driver.save_screenshot("radio3.png")

# radio3 is enabled/selected: False
# radio3 is enabled/selected: True
"""
